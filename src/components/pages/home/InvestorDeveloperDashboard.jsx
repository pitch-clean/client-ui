    ...
    <div>
      ...
      >
        ...
        >
          ...
          >
            Transactions on Pitchclean are processed and stored using blockchain,<br/>
        ...
        <div className="infoCard flexcol h100" style={infoCardStyle} >
          ...
          <div className="paragraph" style={paragraphStyle} >
            Pitchclean does the hard work for you: <br/>
        ...
        <div className="infoCard flexcol h100" style={infoCardStyle} >
          ...
          <div className="paragraph" style={paragraphStyle} >
            Pitchclean's relationships with smaller<br/>
