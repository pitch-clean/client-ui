...
The content on this detail page was produced by the Sponsor or an affiliate thereof. The Sponsor is under no obligation to update this detail page. None of the opinions expressed on this detail page are the opinions of EcoFunded and they are not endorsed by EcoFunded. Assumptions and projections included in this detail page are not reflective of the position of EcoFunded or any other person or entity other than [Sponsor Name], a Delaware limited liability company (the “Issuer”) or its affiliates.
...
Interests in the Issuer are listed on the EcoFunded Marketplace. EcoFunded receives fees from the Sponsor or the investment vehicle partially based on the number of investor rooms created. This arrangement could create a conflict of interest between CrowdStreet and investors.
Certain EcoFunded employees may have an interest in, or family members or close friends of EcoFunded employees may have an interest in, or employment or other relationship with, the Issuer or one of its affiliates. Although EcoFunded has a thorough screening process with respect to each investment opportunity, the fact that EcoFunded employees may have an interest in, or may have family members or close friends with an interest in, or employment or other relationship with, the Issuer or one of its affiliates could create an incentive for EcoFunded to approve the Issuer for the Marketplace.
`,
    },
    images: {
