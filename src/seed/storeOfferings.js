...
export const offeringsObj = {
  "ase1wefa": {
    ...
    "img": 'https://test.io',
    "images": {
      "large": getImgPath(`extern4l-content.duckduckgo.com.jpg`),
      "thumbnail": getImgPath(`extern4l-content.duckduckgo.com.jpg`),
      "carousel": []
    },
  },
  "v7vcv89": {
  ...
  "zxcv098": {
    ...
    "img": 'https://test.io',
    images: {
      "large": getImgPath(`1980_schwinn_air_dyne_ergometric_exerciser.png`),
      "thumbnail": getImgPath(`1980_schwinn_air_dyne_ergometric_exerciser.png`),
      "carousel": []
    },
  },
  "mnb32": {
